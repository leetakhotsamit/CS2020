...
def after_tax(cost, prov_abbr, item):
   ...
   tax (PST, GST) applied based on the province abbreviation (prov_abbr). 
   The item can be anything. However, there are exceptions for food, literature 
   and child goods.
   
   after_tax: Float Str Str -> Float
   
   requires:
   * food is exempt from all taxes
